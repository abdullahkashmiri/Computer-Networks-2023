//21l7512 bscs 5g1 cn lab 7 q2 client .c
...
do {
    ...
    if (recv(socket_desc, server_message, sizeof(server_message) - 1, 0) < 0) {
        printf("Receive Failed. Error!!!!!\n");
        return -1;
    }
    ...
    // Print the received message unless it contains "data completed"
    if (strstr(server_message, "data completed") == NULL) {
        printf("%s\n", server_message);
break;
    }
...
} while (strcmp(server_message, "data completed") != 0);
 ...
 memset(server_message,'\0',sizeof(server_message));
        ...
        printf("Enter Your Vote Symbol Only\n");
        printf("Becareful Invalid Symbol will make your vote void.\n");
        printf("Enter Vote here: ");
